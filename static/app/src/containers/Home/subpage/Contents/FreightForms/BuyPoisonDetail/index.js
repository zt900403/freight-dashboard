...
class BuyPoisonDetail extends React.PureComponent {
    ...
    render() {
        ...
        , {
            ...
            title: 'A数量',
            dataIndex: 'poisonANumber',
            key: 'poisonANumber',
        }, {
            title: 'B数量',
            dataIndex: 'poisonBNumber',
            key: 'poisonBNumber',
        }, {
            title: '购买证号',
            ...
            title: '运往地',
            dataIndex: 'poisonDestination',
            key: 'poisonDestination',
        }]
...
export default Form.create()(BuyPoisonDetail)